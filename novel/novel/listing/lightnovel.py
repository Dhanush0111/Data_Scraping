...
class Vodtw:
    ...
    def scrape(self, url):
        ...
        chapter_title = soup.select_one(".chapter-title").text

        paragraphs = soup.select("#chapter-container p")
        # if paragraphs:
        ...
        next_chapter = soup.select_one('a[rel="next"]')['href']
        print(next_chapter)
...
if __name__ == "__main__":
    ...
    page_start = 201
    page_end = 250
    url = "https://www.lightnovelworld.co/novel/absolute-sword-sense-1527/chapter-201"
